...
final class RandomPromotionsFixturesTest extends KernelTestCase
{
    ...
    public function it_creates_random_promotions(): void
    {
        ...
        /** @var Fixture $fixture */
        $fixture = self::getContainer()->get('sylius.fixtures_plugin.doctrine.fixtures.random_promotions');
    ...
    {
        return static::getContainer()->get('sylius.repository.promotion');
    }
}
