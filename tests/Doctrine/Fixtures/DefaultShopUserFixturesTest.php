...
final class DefaultShopUserFixturesTest extends KernelTestCase
{
    ...
    public function it_creates_default_shop_users(): void
    {
        ...
        /** @var Fixture $fixture */
        $fixture = self::getContainer()->get('sylius.fixtures_plugin.doctrine.fixtures.default_shop_users');
